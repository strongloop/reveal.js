...
var Reveal = (function(){
	...
	function initialize( options ) {
		...
		this.clientEditor = ace.edit("editor");
		//this.clientEditor.setTheme("ace/theme/idle_fingers");
		this.clientEditor.getSession().setMode("ace/mode/javascript");
		dom.clientEditorEl = document.getElementById("editor");
	...
	function toggleCodeEditor(el) {
		dom.wrapper.classList.toggle("split");
		dom.clientEditorEl.classList.toggle("active");
		dom.controls.classList.toggle("splitview");
		if (el.classList.toggle("active")) {
			this.clientEditor.focus();
		}
		else {
			this.clientEditor.blur();
		}
		onWindowResize();
	}
	...
	return {
		...
		// Toggles visibility of the code editor
